...
const SurgeriesPage = () => {
  const service = {
    name: 'Major and Minor Surgery Service ',
    images: [
      '/surgeries.jpg' ,// Replace with your first image path
      '/surrey.jpg', // Replace with your second image path
    ],
    description:
  ...
  return (
    <div>
      ...
      <div className=" mx-auto  space-y-8">
        {/* Service Name Bar */}
        <div className="bg-gradient-to-r from-blue-200 to-blue-400 text-white justify-between items-center flex px-6 py-6 shadow-lg">
          <h1 className="text-4xl font-extrabold row-span-1">{service.name} </h1>
          <div className=' text-7xl'><GiMedicalDrip/></div>
        </div>

        {/* Service Images */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-1/2 px-3">
