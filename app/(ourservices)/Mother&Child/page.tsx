...
const EyeClinicPage = () => {
  const service = {
    name: 'Mother & Child Care Service',
    images: [
      '/kasa img 2.jpg' ,// Replace with your first image path
  ...
  return (
    <div>
      ...
      <div className=" mx-auto space-y-8">
        {/* Service Name Bar */}
        <div className="bg-gradient-to-r from-blue-200 to-blue-400 text-white text-center py-6 px-6 shadow-lg flex justify-between items-center">
